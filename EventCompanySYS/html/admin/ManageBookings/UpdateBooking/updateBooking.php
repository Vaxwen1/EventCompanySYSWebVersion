   ...
   <h1>Update Booking</h1>
    <div class="mainContainer">
        <div class="regForm">  
            ...
            <form class="form" onsubmit="return validateBooking()" method="get">
    
                
                <div class="form-group">
                    <label>BookingID</label>
                    <input type="text" name = "bBookingID" value="<?php if (isset($id)) echo $id; ?>" readonly>
                </div>

                <div class="form-group">
                    <label>Email</label>
                    <input type="text" id="email" name="bEmail" value="<?php if (isset($email)) echo $email; ?>">
                </div>

                <div class="form-group">
                    <label>Event</label>
                    <input type="text" id="eventName" value="<?php if (isset($eventName)) echo $eventName; ?>" readonly>
                    <input type="hidden" id="eventID" name="bEventID" value="<?php if (isset($eventid)) echo $eventid; ?>">
                </div>

                <div class="form-group">
                    <label>Number of tickets</label>
                    <input onchange = "calculatePrice()" type="number" id="eNumberOfTickets" name = "bNumberOfTickets" value="<?php if (isset($numberOfTickets)) echo $numberOfTickets; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="priceInput"  name="bPrice" readonly value="<?php if (isset($price)) echo $price; ?>">
                </div>
